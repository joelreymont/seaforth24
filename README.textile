h1. This is the Mac OSX (x86-32) driver for the "IntellaSys FORTHdrive": 	 http://www.intellasys.net/index.php?option=com_content&task=view&id=62&Itemid=77 thumb stick evaluation board. The FORTHdrive houses a SEAforth24 CPU (24-core) as well as a 1GiB flash disk with the VentureForth development kit.
